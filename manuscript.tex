...
\(^c\)Zenodo mia community. \(^d\)HoloFood microbiome datasets are
deposited in the MGnify database. HMP, Human Microbiome Project.
...
phylogenetic-aware and non-phylogenetic metrics, covering both
prevalence- and abundance-based approaches, along with repeated
rarefaction \citep{schloss2024b} through the \emph{mia} package. Other
global indices of community state include measures of dominance, rarity,
