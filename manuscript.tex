...
we illustrate: \textbf{(a)} taxonomic visualization through phylogenetic
trees and abundance heatmaps; \textbf{(b--d)} common single-omic
analyses including Faith's phylogenetic diversity \citep{armstrong2021},
community composition ordination (dbRDA based on UniFrac dissimilarities
\citep{lozupone2005}), and differential prevalence testing
\citep{nickols2026}; and \textbf{(e--f)} multi-omic integration
strategies combining microbiota and metabolomics data through
unsupervised dimensionality reduction (Joint-RPCA \citep{vargas2026}) to
identify shared variation across data layers, and supervised machine
learning (IntegratedLearner \citep{mallick2024}) to rank features by
their strength of association with experimental conditions or phenotypes
of interest.}
