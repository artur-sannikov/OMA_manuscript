...
\textbf{a}, Taxonomic relationships among bacterial genera are shown as
a phylogenetic tree alongside a heatmap of their abundances across
samples. Samples are grouped by diet group. Most genera belong to the
phylum \emph{Firmicutes}, while \emph{Alistipes} and
\emph{Parabacteroides} have the highest mean abundances.
\textbf{Single-omic analyses (b--d)} demonstrate common analyses of
individual microbiome data layers. \textbf{b}, Faith's phylogenetic
diversity \citep{armstrong2021} summarizes within-sample microbial
diversity and shows no clear difference between diet groups. \textbf{c},
Distance-based redundancy analysis (dbRDA) based on UniFrac distances
\citep{lozupone2005} visualizes differences in microbial community
composition explained by the experimental variables, revealing
